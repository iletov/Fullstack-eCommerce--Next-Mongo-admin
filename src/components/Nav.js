...
export default function Nav({ showNav }) {
  ...
  const activeLink = inactiveLink + ' bg-white text-black rounded-sd';
  ...
  return (
    <aside className={(showNav ? 'left-0' : ' -left-full') + " top-0 text-gray-600 p-4 pr-4 fixed bg-bgGray w-full h-full md:static md:w-auto transition-all"} >
      ...
      <nav className="flex flex-col gap-2">
        ...
        <Link href={'/products'} className={pathname.includes('/products') ? activeLink : inactiveLink}>
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class={pathname.includes('/products') ? activeIcon : inactiveIcon}>
        ...
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className={pathname.includes('/admins') ? activeIcon : inactiveIcon}>
